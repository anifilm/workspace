...
namespace Lambda
{
    ...
    // or expression tree types. By using lambda expression, you can write local functions
    // that can be passed as arguments or returned as the value of function calls.
    // Lambda expressions are particulary helpful for writing LINQ query expressions.
    ...
    class Program
    {
        ...
        public static void DoSomething()
        {
            ...
            oddNumbers.ForEach(i => { Console.WriteLine("Odd number: {0}", i); });
