...
def merge_and_sort(list_data_a, list_data_b):
    ...
    merge_list_data = list_data_a + list_data_b
    merge_list_data.sort()

    result = merge_list_data
...
def number_of_cases(list_data):
    ...
    for i in list_data:
        for j in case_data:
            result_data = str(i)+str(j)
            result_case.append(result_data)

    result_case = list(set(result_case))
    result_case.sort()
