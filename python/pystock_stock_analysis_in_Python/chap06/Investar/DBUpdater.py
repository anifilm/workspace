...
class DBUpdater:
        ...
        with self.conn.cursor() as curs:
            ...
            if rs[0] is None or rs[0].strftime("%Y-%m-%d") < today:
                ...
                for idx in range(len(krx)):
                    ...
                    sql = (
                        f"REPLACE INTO company_info (code, company, last"
    ...
    def read_naver(self, code, company, pages_to_fetch):
        ...
        try:
            ...
            for page in range(1, pages + 1):
                ...
                tmnow = datetime.now().strftime("%Y-%m-%d %H:%M")
                print(
                    "[{}] {} ({}) : {:04d}/{:04d} pages are downloading...".format(
    ...
    def execute_daily(self):
        ...
        if tmnow.month == 12 and tmnow.day == lastday:
            ...
            tmnext = tmnow.replace(
                month=tmnow.month + 1, day=1, hour=17, minute=0, second=0
            )
        else:
        ...
        print(
            "Waiting for next update ({}) ... ".format(
