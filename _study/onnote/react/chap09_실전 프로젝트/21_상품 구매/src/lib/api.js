...
export const writeItem = (formData) =>
  client.post('/items', formData, {
    headers: { 'Content-Type': 'multipart/form-data' },
  });
export const modifyItem = (itemId, formData) =>
...
export const fetchNotice = (noticeNo) =>
  client.get(`/notices/${noticeNo}`);
export const writeNotice = (title, content) =>
  client.post('/notices', { title, content });
export const modifyNotice = (noticeNo, title, content) =>
  client.put(`/notices/${noticeNo}`, { title, content });
export const removeNotice = (noticeNo) =>
  client.delete(`/notices/${noticeNo}`);
// 코인 충전 API 호출 함수
export const fetchChargeCoinList = () => client.get('/coins');
export const chargeCoin = (amount) =>
...
export const fetchUserItem = (userItemNo) =>
  client.get(`/useritems/${userItemNo}`);
// 구매상품 다운로드 API 호출 함수
export const downloadUserItem = (userItemNo) =>
