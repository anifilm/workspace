...
MYPAINTER.app.Main = function () {
  this.main = function () {
    // 함수의 최상단에 의존 관계 선언 후 사용
    var constants = MYPAINTER.app.Constants;
    console.log('main');
    console.log(constants.TITLE);  // Painter
    console.log(constants.WIDTH);  // 600
    console.log(constants.HEIGHT); // 400
  }
};
...
var painterMain = new MYPAINTER.app.Main();
