...
export default {
  ...
  methods: {
    // 데이터 값을 출력한다.
    onSubmit() {
      const { userId, userPw, introduction, developer, foreigner, hobbyList, gender, nationality, carList } = this;
