/* 12
"quit"를 입력할 때까지 계속해서 단어를 입력받아 2차원 동적 배열에 저장한 뒤 그 동안 입력된 단어를 출력하는 다음
프로그램을 완성하라. 여기서 각 행은 단어를 가리키는 포인터다. 따라서 단어가 계속 들어올 때마다 행의 수도 realloc
을 써서 늘려가야 한다. 또, 입력 단어도 malloc을 써서 단어 크기에 맞는 만큼의 공간에 저장해야 한다.
*/
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
