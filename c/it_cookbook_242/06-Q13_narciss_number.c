/* 13
자아도취 수(Narcissistic Number, Armstrong Number)는 각각의 자릿수에 총 자릿수의 승수를 취해 더한 숫자와
원래의 숫자가 동일한 경우를 말한다. 예를 들어, 153 = 1³ + 5³ + 3³, 1634 = 1⁴ + 6⁴ + 3⁴ + 4⁴ 이므로 자아도취
수다. 입력 숫자가 주어지면 그것이 자아도취 수인지를 판별하는 프로그램을 작성하라.
