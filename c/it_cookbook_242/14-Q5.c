/* 05
입력 문자열을 암호화하여 2진 파일인 encrypt.bin 파일을 작성하라. 단, 암호화 방식은 씨저 사이퍼(Caesar Cipher)를
사용하되 암호 키만큼 건너뛰어야 한다. 이후 encrypt.bin 파일을 읽은 뒤 그것을 복원(decryption)하여 화면에 출력하라.
또, 복원된 내용이 원래 입력한 내용과 같은지를 확인하라.
*/
#include <stdio.h>
#include <stdlib.h>
