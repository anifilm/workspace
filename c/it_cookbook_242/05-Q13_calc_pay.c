/* 13
현행 가정용 전기 요금 누진제에 의하면 월 소비량이 200Kwh 이하일 경우 기본 요금 910원에 단가 93.3원이다.
또, 201Kwh 부터 400Kwh 까지는 기본요금 1600원에 단가 187.9원 이고 401Kwh 이상은 기본요금 7300원에 단가
280.6원 이다. 하지만 여름과 겨울에 1000Kwh 를 초과하면 기본요금 7300원에 단가 709.5원이 적용된다. 이렇게
