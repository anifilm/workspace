// 22 변형이 있을 수 있지만 일반적인 369 게임의 규칙은 다음과 같다. 숫자에 3이나 6이나 9가 들어가면
// 369 수다. 그 경우에 그것이 들어간 개수만큼 박수를 친다. 예를 들어, 36은 박수를 두번 친다. 그 외의
// 숫자는 박수를 치지 않고 숫자를 말하면 된다. 1부터 입력 N까지 숫자에 대해 369 게임을 할 경우의 출력을
// 작성하라.
