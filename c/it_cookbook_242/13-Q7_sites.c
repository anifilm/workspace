/* 07
다음 프로그램을 완성하여 입력받은 관광지 정보 세 개를 모두 출력하라. 여기서 개별 관광지 정보는 구조체이며 프로그램은
그 구조체를 가리키는 포인터 배열(array of pointers to structures)을 활용하고 있다. 프로그램을 실행하여 관광지 정보
세 개를 입력받은 후 모든 관광지 정보를 출력하라.
*/
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
