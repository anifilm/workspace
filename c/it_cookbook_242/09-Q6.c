// 06 기호 1번, 2번, 3번 세 사람이 선거에 출마했다고 가정하자. 당선이 확정되려면 과반수 득표에
// 성공해야 한다. 예를 들어 10명이 투표를 했는데 결과가 2, 2, 2, 2, 2, 3, 3, 3, 1, 1이 나왔다
// 면 2번이 다수 득표자이지만 당선자는 없다. 과반수가 아니기 때문이다. 1번부터 8번까지 출마했을
// 때 10명의 투표 결과를 입력받아 당선자가 없으면 없다고 알리고, 있으면 기호 몇번이 당선되었는지
// 알리는 프로그램을 작성하라.
