...
int main() {
    ...
    // Determine if an entered interger is between two other integers
    // assume lower < upper
    ...
    // Determine if an entered interger is exactly on the boundary
    // assume lower < upper
    cout << "Enter an integer - the bounds are " << lower << " and " << upper << " : ";
    cin >> num;
    ...
    const int wind_speed_for_coat {25};         // wind over this value requires a caot
